package com.google.android.gms.samples.wallet.ui.login
...
import com.google.android.gms.samples.wallet.InputUtils
...
class LoginFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.login_button).setOnClickListener {
            ...
            val users = databaseHelper?.getUser(emailAddress.text.toString(),password.text.toString())
